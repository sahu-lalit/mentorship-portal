...
export const MentorDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      ...
      {/* Left Sidebar */}
      <aside
        className={`w-64 bg-white dark:bg-gray-800 shadow-xl border-r border-gray-200 dark:border-gray-700 fixed h-full z-50 transform transition-all duration-300 ease-in-out ${
      ...
      >
        <div className="p-6">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-bold text-lg text-gray-900 dark:text-white">Mentor</h2>
          ...
          <nav className="space-y-1">
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 ${
                activeTab === 'home'
                  ? 'bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 text-blue-700 dark:text-blue-400 shadow-sm scale-[1.02]'
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
          <Button variant="outline" size="sm" onClick={handleLogout} className="w-full hover:border-red-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20">
